  ...
  return (
    <div className='flex flex-col gap-y-8'>
      <input
        ...
        className="input input-bordered border w-full max-w-xs"
      />
      <textarea
        placeholder="Message"
        value={message}
        onChange={(e) => setMessage(e.target.value)}
        className="textarea textarea-bordered border w-full max-w-xs"
      />
      <br></br>
      <button
        className="btn btn-xs border cursor-pointer lg:btn-md btn-primary"
      ...
      <div className="card-body items-center text-center">
        <div className="space-y-6">
          ...
          <div className="card-actions justify-around">
            ...
            />
            <button
              className="btn btn-xs lg:btn-md btn-primary border text-blue-500"
              onClick={handleSubmit}
